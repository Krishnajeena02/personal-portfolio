...
const ServiceCard = ({ image, title, description, features }) => (
  <motion.div
    ...
    whileTap={{ scale: 0.97 }}
    className="w-72 min-h-[400px] bg-white border rounded-xl shadow-md p-4 flex flex-col justify-start hover:shadow-2xl transition-all duration-300 cursor-pointer dark:bg-[#13293d] dark:border-gray-700"
  >
    ...
    <div>
      ...
      >
        <motion.h1
          ...
          className="text-5xl font-bold text-center mb-4 text-[#FD1F4A]"
        >
          Our Services
        </motion.h1>
        ...
        <motion.h4
          ...
          className="text-2xl font-semibold text-gray-900 dark:text-gray-800 text-center mb-10"
        >
