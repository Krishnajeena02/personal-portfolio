  ...
  return (
    <section className='bg-black-400 text-white relative overflow-hidden py-16 px-6 md:px-12'>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-14 items-start relative z-10">
        ...
        >
          <h1 className="text-4xl font-bold text-[#7DA4E3] leading-tight">
          ...
          <div className="space-y-4 text-gray-800 text-base">
            <div className="flex items-center gap-3">
              ...
              <span>krishnajeena2005@gmail.com</span>
            </div>
            <div className="flex items-center gap-3">
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            className="w-full  bg-[#07B7DC] hover:bg-[#00ABCF] text-white font-semibold py-3 px-6 rounded-lg transition duration-300 cursor-pointer"
          >
            Send Message
          </motion.button>
        </motion.form>
